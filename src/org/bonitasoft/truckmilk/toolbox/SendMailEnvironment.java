 ...
 * class is correclty deployed.
 * But to verify that, the verification must be in a class who don't use at all any reference to the
 * mail class, so in a different class.
 * 
