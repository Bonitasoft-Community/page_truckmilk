...
public class MilkReplayFailedTask extends MilkPlugIn {
  ...
  private static PlugInParameter cstParamDelayInMinutes = PlugInParameter.createInstance("delayinmn", TypeParameter.LONG, 5, null);
  private static PlugInParameter cstParamMaximumTentative = PlugInParameter.createInstance("maxtentative", TypeParameter.LONG, 5, null);
  ...
  public PlugInDescription getDescription() {
    ...
    plugInDescription.displayName = "Replay Failed Task";
