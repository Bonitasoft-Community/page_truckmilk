...
public interface MilkSchedulerInt {
    ...
    /**
     * initialize. Then the schedule must call back the engine on the method  milkCmdControl.executeOneTime( tenantId );
     * @param tenantId
     * @param forceReset
     * @return
     */
     ...
     * @return
     */
    public enum TypeStatus { STOPPED, SHUTDOWN,STARTED };
     ...
     *
     */
    public enum TypeScheduler { QUARTZ, THREADSLEEP };
